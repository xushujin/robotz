...
import com.hatim.smartqq.client.SmartQQClient;
    ...
    public String startService() {
        ...
        client = new SmartQQClient(new MessageCallback() {
            ...
            public void onMessage(Message msg) {
                ...
                try {
                    if (msg.getContent().contains(CONTAINS_KEY)) {
                        client.sendMessageToFriend(msg.getUserId(), getFriendNick(msg) + ",大爷你好！");
                    }
            ...
            public void onGroupMessage(GroupMessage msg) {
                ...
                try {
                    if (msg.getContent().contains(CONTAINS_KEY)) {
                        client.sendMessageToGroup(msg.getGroupId(), "@" + getGroupUserNick(msg) + " 大爷你好！");
                    }
            ...
            public void onDiscussMessage(DiscussMessage msg) {
                ...
                try {
                    if (msg.getContent().contains(CONTAINS_KEY)) {
                        client.sendMessageToDiscuss(msg.getDiscussId(), "@" + getDiscussUserNick(msg) + " 大爷你好！");
                    }
